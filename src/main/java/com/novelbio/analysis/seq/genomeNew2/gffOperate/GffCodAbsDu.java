	...
	public ArrayList<T> getAllGffDetail() {
		...
		if (getGffCodLeft() != null && getGffCodLeft().isInsideLoc()) {
			if (getGffCodLeft().isInsideUp())
				lsGffDetailAll.add(getGffCodLeft().getGffDetailUp().getGffDetail());
			lsGffDetailAll.add(getGffCodLeft().getGffDetailThis().getGffDetail());
		}
		...
		if (getGffCodRight() != null && getGffCodRight().isInsideLoc()) {
			if (getGffCodRight().isInsideDown())
				lsGffDetailAll.add(getGffCodRight().getGffDetailDown().getGffDetail());
			lsGffDetailAll.add(getGffCodRight().getGffDetailThis().getGffDetail());
		}
