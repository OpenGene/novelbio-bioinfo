...
public class GffDetailGene extends GffDetailAbs
{
    ...
    protected int getIsolistID(String splitID) {
    	return lsIsoName.indexOf(splitID);
	}
    protected int getLongestSplitID() {
	...
	@Override
	public GffDetailGeneCod setCood(int coord) {
		return new GffDetailGeneCod(this, coord);
	}
