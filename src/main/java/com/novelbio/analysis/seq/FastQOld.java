 ...
 * 
 */
public class FastQOld extends SeqComb {
	private static Logger logger = Logger.getLogger(FastQOld.class);
	...
	public static void main(String[] args) {
		FastQOld.convertSff2FastQ("/media/winF/NBC/Project/Project_Invitrogen/sRNA/CR_miRNA.fasta", true);
...
//			hashFastQFilter.put(2, 1);
	 ...
	 * 
	 */
	public FastQOld(String seqFile1, String seqFile2, int FastQFormateOffset,
			int QUALITY) {
	 ...
	 */
	public FastQOld(String seqFile1, String seqFile2, int QUALITY) {
	 ...
	 * @param QUALITY
	 */
	public FastQOld(String seqFile1, int QUALITY) {
	 ...
	 * @throws Exception
	 */
	public FastQOld filterReads(String fileFilterOut) {
		setFastQFormat();
		try {
			return filterReadsExp( fileFilterOut);
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	private FastQOld filterReadsExp2(String fileFilterOut) throws Exception {
		setFastQFormat();
		FastQOld fastQ = new FastQOld(fileFilterOut, FastQOld.QUALITY_MIDIAN);
		for (FastQRecord fastQRecord : readlines()) {
		...
		FastQOld fastQ1 = null;

		if (booPairEnd) {
			fastQ1 = new FastQOld(fileFilterOut.trim() + "_1", fileFilterOut.trim()
					+ "_2", offset, quality);
		} else {
			fastQ1 = new FastQOld(fileFilterOut.trim(), null, offset, quality);
		}
	 ...
	 * @throws Exception
	 */
	private FastQOld filterReadsExp(String fileFilterOut) throws Exception {
		setFastQFormat();
		...
		if (booPairEnd) {
			fastQ = new FastQOld(fileFilterOut.trim() + "_1", fileFilterOut.trim()
					+ "_2", offset, quality);
		} else {
			fastQ = new FastQOld(fileFilterOut.trim(), null, offset, quality);
		}
