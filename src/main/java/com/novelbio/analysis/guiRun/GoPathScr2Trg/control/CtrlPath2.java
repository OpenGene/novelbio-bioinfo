...
public class CtrlPath2 {
	private static final Logger logger = Logger.getLogger(CtrlPath2.class);
	/**
	 * 用单例模式
	 */
	private static CtrlPath2 ctrlPath = null;
		/**
		 * 是否需要blast
		 */
		boolean blast = false;
		 ...
		 * @param guiBlast
		 */
		public static CtrlPath2 getInstance(String geneFileXls,int colAccID,int colFC,double up, double down,String backGroundFile,int QtaxID,
				boolean blast, int StaxID,double evalue) {
			ctrlPath = new CtrlPath2(geneFileXls, colAccID, colFC, up, down, backGroundFile, QtaxID, blast, StaxID, evalue);
			return ctrlPath;
		}
		 ...
		 * @return
		 */
		public static CtrlPath2 getInstance(String geneFileXls,int colAccID,int colFC,String backGroundFile,int QtaxID,
				boolean blast, int StaxID,double evalue) {
			ctrlPath = new CtrlPath2(geneFileXls, colAccID, colFC, backGroundFile, QtaxID, blast, StaxID, evalue);
			return ctrlPath;
		}
		...
		public static CtrlPath2 getCtrlPathUsed()
		{
			return ctrlPath;
		}
		/**
		 ...
		 * @param evalue
		 */
		private  CtrlPath2(String geneFileXls,int colAccID,int colFC,double up, double down,String backGroundFile,int QtaxID,
				boolean blast, int StaxID,double evalue) {
			this.blast = blast;
			this.QtaxID = QtaxID;
			this.StaxID = StaxID;
		 ...
		 * @param evalue
		 */
		private  CtrlPath2(String geneFileXls,int colAccID,int colFC,String backGroundFile,int QtaxID,
				boolean blast, int StaxID,double evalue) {
			this.blast = blast;
			this.QtaxID = QtaxID;
			this.StaxID = StaxID;
