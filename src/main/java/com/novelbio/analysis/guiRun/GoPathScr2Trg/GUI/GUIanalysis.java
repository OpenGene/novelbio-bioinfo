			...
			setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
			{
				...
				getContentPane().add(jTabbedPane1, BorderLayout.CENTER);
				{
						...
						.addGroup(jPanGoLayout.createParallelGroup()
						    .addGroup(jPanGoLayout.createSequentialGroup()
						        .addGroup(jPanGoLayout.createParallelGroup()
						            .addGroup(jPanGoLayout.createSequentialGroup()
						                .addGroup(jPanGoLayout.createParallelGroup()
						                    .addComponent(jLabBGGo, GroupLayout.Alignment.LEADING, 0, 110, Short.MAX_VALUE)
						                ...
						                .addGroup(jPanGoLayout.createParallelGroup()
						                    .addGroup(jPanGoLayout.createSequentialGroup()
						                        ...
						                        .addGroup(jPanGoLayout.createParallelGroup()
						                            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                                .addComponent(jRadBtnQM, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
						                            ...
						                            .addGroup(jPanGoLayout.createSequentialGroup()
						                                ...
						                                .addGroup(jPanGoLayout.createParallelGroup()
						                                    ...
						                                    .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                                        .addGap(25)
						                                        .addComponent(jCombBlastTaxGo, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
						                                        .addGap(0, 0, Short.MAX_VALUE))))))
						                    .addGroup(jPanGoLayout.createSequentialGroup()
						                        .addComponent(jTxtBGGo, GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)
						                        .addGap(0, 0, Short.MAX_VALUE))
						                    .addComponent(jTxtFilePathGo, GroupLayout.Alignment.LEADING, 0, 191, Short.MAX_VALUE)))
						            .addGroup(jPanGoLayout.createSequentialGroup()
						                .addGroup(jPanGoLayout.createParallelGroup()
						                    .addGroup(jPanGoLayout.createSequentialGroup()
						                        .addPreferredGap(jLabGoQtaxID, jRadBtnElim, LayoutStyle.ComponentPlacement.INDENT)
						                        .addGroup(jPanGoLayout.createParallelGroup()
						                            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                ...
						                .addGroup(jPanGoLayout.createParallelGroup()
						                    ...
						                    .addGroup(jPanGoLayout.createSequentialGroup()
						                        .addGap(17)
						                        .addGroup(jPanGoLayout.createParallelGroup()
						                            .addComponent(jBtnFileOpenGo, GroupLayout.Alignment.LEADING, 0, 99, Short.MAX_VALUE)
						                            .addComponent(jBtnBGFileGo, GroupLayout.Alignment.LEADING, 0, 99, Short.MAX_VALUE))))))
					...
					jPanGoLayout.setVerticalGroup(jPanGoLayout.createSequentialGroup()
						...
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanGoLayout.createParallelGroup()
						    .addComponent(jScrollPaneResultGo, GroupLayout.Alignment.LEADING, 0, 339, Short.MAX_VALUE)
						    .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						        .addGap(7)
						        .addGroup(jPanGoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						        ...
						        .addGap(17)
						        .addComponent(jButRunGo, 0, 22, Short.MAX_VALUE)
						        .addGap(6)))
						.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
