...
*/
public class CopyOfCopyOfGUIanalysisSimple2 extends javax.swing.JFrame {
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				CopyOfCopyOfGUIanalysisSimple2 inst = new CopyOfCopyOfGUIanalysisSimple2();
	...
	public CopyOfCopyOfGUIanalysisSimple2() {
		super();
		initGUI();
	}
		...
		try {
			...
			setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
			{
				...
				jTabbedPane1.setPreferredSize(new java.awt.Dimension(1035, 682));
				{
					...
					jPanGo.setPreferredSize(new java.awt.Dimension(1030, 658));
					...
					}
					{
						...
						jBtbSaveGo.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent evt) {
								...
								jTxtGoSave.setText(savefilename);
							}
						});
					}
					{
						...
						jButRunGo.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent evt) {
								System.out.println("jButRunGo.actionPerformed, event="+evt);
								//TODO add your code for jButRunGo.actionPerformed
							}
						});
					}
					{
					...
					jPanGoLayout.setHorizontalGroup(jPanGoLayout.createSequentialGroup()
						...
						.addGroup(jPanGoLayout.createParallelGroup()
						    ...
						    .addGroup(jPanGoLayout.createSequentialGroup()
						        .addGroup(jPanGoLayout.createParallelGroup()
						            .addGroup(jPanGoLayout.createSequentialGroup()
						                .addPreferredGap(jLabBGGo, jRadBtnGoClassP, LayoutStyle.ComponentPlacement.INDENT)
						                .addGroup(jPanGoLayout.createParallelGroup()
						                    ...
						                    .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                        ...
						                        .addGroup(jPanGoLayout.createParallelGroup()
						                            ...
						                            .addGroup(jPanGoLayout.createSequentialGroup()
						                                ...
						                                .addGap(43)
						                                .addGroup(jPanGoLayout.createParallelGroup()
						                                    .addComponent(jBtnFileOpenGo, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE)
						                                    .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                                        .addGap(8)
						                            ...
						                            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                                ...
						                                .addGap(96))
						                            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                                .addComponent(jTxtBGGo, GroupLayout.PREFERRED_SIZE, 217, GroupLayout.PREFERRED_SIZE)
						                                .addGap(6))
						                            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                                .addComponent(jTxtFilePathGo, GroupLayout.PREFERRED_SIZE, 217, GroupLayout.PREFERRED_SIZE)
						                                .addGap(6))
						                            .addComponent(jTxtGoSave, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 223, GroupLayout.PREFERRED_SIZE)))))
						            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                .addComponent(jLabBGGo, GroupLayout.PREFERRED_SIZE, 110, GroupLayout.PREFERRED_SIZE)
						                .addGap(241))
						            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						        ...
						        .addGroup(jPanGoLayout.createParallelGroup()
						            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                .addComponent(jScrollPaneInputGo, GroupLayout.PREFERRED_SIZE, 667, GroupLayout.PREFERRED_SIZE)
						                .addGap(0, 8, Short.MAX_VALUE))
						            .addGroup(jPanGoLayout.createSequentialGroup()
						                .addComponent(jScrollPaneResultGo, GroupLayout.PREFERRED_SIZE, 675, GroupLayout.PREFERRED_SIZE)
						            ...
						            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						                .addComponent(jTabbedPane2, GroupLayout.PREFERRED_SIZE, 667, GroupLayout.PREFERRED_SIZE)
						                .addGap(0, 8, Short.MAX_VALUE)))
						        .addGap(6)))
						.addGap(6));
					jPanGoLayout.setVerticalGroup(jPanGoLayout.createSequentialGroup()
						...
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanGoLayout.createParallelGroup()
						    .addComponent(jScrollPaneInputGo, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
						    .addComponent(jBtnFileOpenGo, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanGoLayout.createParallelGroup()
						    .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						        .addGroup(jPanGoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						        ...
						        .addGap(6))
						    .addComponent(jTabbedPane2, GroupLayout.Alignment.LEADING, 0, 174, Short.MAX_VALUE))
						.addGroup(jPanGoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						...
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanGoLayout.createParallelGroup()
						    .addComponent(jScrollPaneResultGo, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 343, GroupLayout.PREFERRED_SIZE)
						    .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						        .addGap(7)
						        .addGroup(jPanGoLayout.createParallelGroup()
						            .addGroup(GroupLayout.Alignment.LEADING, jPanGoLayout.createSequentialGroup()
						        ...
						        .addGroup(jPanGoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						            ...
						            .addComponent(jTxtGoSave, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE))
						        .addGap(24)
						        .addComponent(jButRunGo, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)))
						.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
...
///////////////////////////////////////////////////
	 ...
	 * 查看文件的鼠标或键盘事件响应时调用
	 */
	private void setGoProviewold(String filePath)
	{
	...
	private void setGoProview(String filePath)
	{
		...
		JScrollPane jScrollPaneltest = new JScrollPane();
		jTabbedPane2.addTab("jScrollPane1", null, jScrollPaneltest, null);
		jTabInputGo = new DefaultTableModel(tableValue,goRawData[0]);
		jTabFInputGo = new JTable();
		jTabFInputGo.setModel(jTabInputGo);
		jScrollPaneltest.setViewportView(jTabFInputGo);
		
		JScrollPane jScrollPaneltest2 = new JScrollPane();
		jTabbedPane2.addTab("go2gene", null, jScrollPaneltest2, null);
		
		JTable jTabFInputGo2 = new JTable();
		DefaultTableModel jTabInputGo2 = new DefaultTableModel(tableValue,goRawData[0]);
		jTabFInputGo2.setModel(jTabInputGo2);
		jScrollPaneltest2.setViewportView(jTabFInputGo2);
		
		
		
		for (int i = 1; i < goRawData.length; i++) {
			jTabInputGo.addRow(goRawData[i]);
			jTabInputGo2.addRow(goRawData[i]);
		}
