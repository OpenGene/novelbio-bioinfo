...
public class CodeCounter {
	public static void main(String[] args) {
		...
		codeCounter = new CodeCounter("/media/winD/fedora/gitnbc/src/main/java/com/novelbio/analysis/seq", "/media/winD/fedora/codestatistics/seqCodeLines.txt");
...
//		codeCounter = new CodeCounter("/media/winD/fedora/gitnbc/src/main/java/com/novelbio/analysis/seq/reseq", "/media/winD/fedora/codestatistics/reseqCodeLines.txt");
//		codeCounter = new CodeCounter("/media/winD/fedora/gitnbc/src/main/java/com/novelbio/analysis/seq/resequencing", "/media/winD/fedora/codestatistics/resequencingCodeLines.txt");
//		codeCounter = new CodeCounter("/media/winD/fedora/gitnbc/src/main/java/com/novelbio/analysis/seq/rnaseq", "/media/winD/fedora/codestatistics/rnaseqCodeLines.txt");
