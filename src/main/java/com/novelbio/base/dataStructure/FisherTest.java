...
public class FisherTest implements StatisticsTest{
    ...
    public static void main(String[] args) {
        ...
        argInts[3] = new int[]{1000, 200, 33000, 3600};
        ...
        FisherTest fe = new FisherTest(43000);
     ...
     */
    public FisherTest(int maxSize) {
    	setMaxSize(maxSize);
    }
    
     public FisherTest(int maxSize, boolean useLookup) {
