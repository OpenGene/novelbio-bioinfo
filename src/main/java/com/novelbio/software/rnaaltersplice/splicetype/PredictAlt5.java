...
public class PredictAlt5 extends PredictAlt5Or3 {
	...
	public List<? extends Alignment> getBGSiteSplice() {
		...
		alignBG = new Align(exonCluster.getChrId(), startBGcis, startSpliceCis);
	 ...
	 */
	protected void find() {
		mapEdge2Iso = new HashMap<Integer, GffIso>();
		Align align = null;
		...
		for (ExonInfo exonInfo : lsExon) {
			...
			if (exonCluster.getExonClusterAfter().isIsoCover(gffGeneIsoInfo)) {
				if (align == null) {
