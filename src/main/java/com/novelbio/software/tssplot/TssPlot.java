...
import com.novelbio.bioinfo.base.ExceptionNBCAlignError;
...
public class TssPlot {
	...
	public void readRegionFile(String regionBedFile) {
		...
		for (String content : txtRead.readlines()) {
			...
			} catch (ExceptionNBCAlignError e) {
				txtRead.close();
				throw new ExceptionNBCAlignError("generate regbed error on line " + content + "\n" + e.getMessage());
			} catch (Exception e) {
				txtRead.close();
				throw new ExceptionNBCAlignError("generate regbed error on line " + content, e);
			}
		}
		txtRead.close();
	}
