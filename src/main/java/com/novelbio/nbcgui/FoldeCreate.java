...
public class FoldeCreate {
	/** 如果输入的最后一个文件夹名字中包含这个名字，则不创建，直接返回该文件夹
	 * 否则创建一个文件夹
	 *  譬如 pathPrefix = "/your/path/1、GOanalysis/go"
	 *  foldName = "GOanalysis";
	 *  则返回 "/your/path/1、GOanalysis/go"
	 *  
	 *  pathPrefix = "/your/path/Novelbio/go"
	 *  foldName = "GOanalysis";
	 *  则返回 "/your/path/Novelbio/GOanalysis/go"
	 *  @param pathPrefix
