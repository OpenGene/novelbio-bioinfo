...
public class KGCentry2Gen {
	...
	public void setKGIDgen2Keg(KGIDgen2Keg kgIDgen2Keg) {
		this.kgIDgen2Keg = kgIDgen2Keg;
	}
	public KGIDgen2Keg getKGIDgen2Keg() {
		return this.kgIDgen2Keg;
	}
