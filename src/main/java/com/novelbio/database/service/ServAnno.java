...
public class ServAnno {
	...
	public static String[] getAnno(String accID, int taxID,boolean blast,int StaxID,double evalue)
	{
		...
		if (blast) {
			...
			if (ncbiFlag || uniprotFlag) {
				...
				ArrayList<BlastInfo> lsSblastInfos = servBlastInfo.queryLsBlastInfo(blastInfo);
				//如果有blast的结果
	...
	public static String[] getGenInfo(long geneID)
	{
		...
		GeneInfo geneInfo2 = servGeneInfo.queryGeneInfo(geneInfo);
	...
	public static String[] getUniGenInfo(String uniID)
	{
		...
		UniGeneInfo uniGeneInfo2 = servUniGeneInfo.queryUniGeneInfo(uniGeneInfo);
	...
	public static GeneInfo getGenInfo(NCBIID ncbiid) {
		...
		return servGeneInfo.queryGeneInfo(geneInfo);
	}
	/**
	 * 用uniProtID的uniID去搜索
	 * @param ncbiid
	...
	public static UniGeneInfo getUniGenInfo(UniProtID uniProtID) {
		...
		return servUniGeneInfo.queryUniGeneInfo(uniGeneInfo);
	}
}
