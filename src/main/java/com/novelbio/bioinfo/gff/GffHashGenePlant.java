	   ...
	   for (String content : txtgff.readlines()) {
		   ...
		   if (hashgene.contains(ss[2])) {
			   ...
			   if (gffDetailLOC != null) {
				   for (GffIso gffGeneIsoInfo : gffDetailLOC.getLsCodSplit()) {
			   ...
			   if(geneName != null) {
				   gffDetailLOC = new GffGene(LOCList, geneName, ss[6].equals("+") || ss[6].equals("."));//新建一个基因类
