package com.novelbio.bioinfo.annotation.pathway.kegg.kgpath;
...
import com.novelbio.bioinfo.annotation.pathway.network.KGpathScr2Trg;
...
public class Scr2Target {
	 ...
	 * @throws Exception
	 */
	public static void getGene2RelateKo2(String pathName, ArrayList<String> lsKeggID,String ResultFIleScr2Target,
			String resultFIleAttribute,int QtaxID) throws Exception {
		ServKEntry servKEntry = new ServKEntry();
		/**
		 * 保存关系的一个list，object[2]
		 * 0：qGenKegInfo[7]<br>
	 ...
	 * @throws Exception
	 */
	private static void getRelation2(String pathName, ArrayList<Object[]> lsRelationInfo,
			int QtaxID,String ResultFIleScr2Target, String resultFIleAttribute) throws Exception {
		//source 2 target 的表格
