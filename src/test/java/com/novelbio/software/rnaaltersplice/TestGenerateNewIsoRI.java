...
public class TestGenerateNewIsoRI {
	...
	private void testGenerateGene(boolean isCis5To3) {
		...
		GffGene gffDetailGene1Cis = new GffGene("chr1", "Test", isCis5To3);		
		GffIso gffGeneIsoInfo1 = GffIso.createGffGeneIso("test1", "test", GeneType.mRNA, isCis5To3);
		...
		Map<JunctionUnit, GffIso> mapJunc2Iso = generateNewIso.getMapJunc2IsoNeedReconstruct(lsJuncNeedReconstruct);
		...
		GffIso gffGeneIsoInfo = GenerateNewIso.reconstructIso(juncUnit1, mapJunc2Iso.get(juncUnit1));
