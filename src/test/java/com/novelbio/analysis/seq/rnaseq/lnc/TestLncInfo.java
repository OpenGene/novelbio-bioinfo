...
public class TestLncInfo extends TestCase {
	public void testCalculate() {
		...
		GffGeneIsoInfo iso2 = new GffGeneIsoCis("testIso1", "testGene", GeneType.mRNA);
		...
		GffGeneIsoInfo iso3 = new GffGeneIsoCis("testIso1", "testGene", GeneType.ncRNA);
		...
		GffGeneIsoInfo iso4 = new GffGeneIsoTrans("testIso1", "testGene", GeneType.ncRNA);
		iso4.add(new ExonInfo(false, 1900, 2000));
		iso4.add(new ExonInfo(true, 1700, 1800));
		iso4.add(new ExonInfo(true, 1200, 1300));
		iso4.add(new ExonInfo(true, 1000, 1100));
