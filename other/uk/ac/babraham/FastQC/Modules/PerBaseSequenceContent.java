...
public class PerBaseSequenceContent extends FastQCmodules implements QCModule {
	...
	public BufferedImage getBufferedImage(int width, int heigth){
		...
		BufferedImage b = new BufferedImage(Math.max(width, xCategories.length*15),heigth,BufferedImage.TYPE_INT_RGB);
	...
	public String getSavePath(String outPrefix) {
		return FileOperate.changeFilePrefix(outPrefix, "BaseSequence_", "png");
	} 
